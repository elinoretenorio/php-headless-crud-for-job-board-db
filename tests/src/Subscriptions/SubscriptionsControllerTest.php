...
use JobBoard\Subscriptions\{ SubscriptionsDto, SubscriptionsModel, SubscriptionsController };
...
class SubscriptionsControllerTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        $this->input = [
            "id" => 275,
            "email" => "andersonlaura@example.net",
            "category_id" => 3716,
            "city_id" => 6918,
            "token" => "there",
            "last_sent" => "2021-09-22 10:43:17",
            "is_confirmed" => 7182,
            "created" => "2021-09-22 17:07:19",
        ];
        $this->dto = new SubscriptionsDto($this->input);
        $this->model = new SubscriptionsModel($this->dto);
        $this->service = $this->createMock("JobBoard\Subscriptions\ISubscriptionsService");
