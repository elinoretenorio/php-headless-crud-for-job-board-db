...
use JobBoard\Cities\{ CitiesDto, CitiesModel, ICitiesService, CitiesService };
...
class CitiesServiceTest extends TestCase
{
    ...
    {
        $this->repository = $this->createMock("JobBoard\Cities\ICitiesRepository");
        $this->input = [
            "id" => 8786,
            "name" => "body",
            "description" => "miss",
        ...
        $this->service = new CitiesService($this->repository);
    }
