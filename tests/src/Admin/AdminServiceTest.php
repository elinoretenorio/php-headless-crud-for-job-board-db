...
use JobBoard\Admin\{ AdminDto, AdminModel, IAdminService, AdminService };
...
class AdminServiceTest extends TestCase
{
    ...
    {
        $this->repository = $this->createMock("JobBoard\Admin\IAdminRepository");
        $this->input = [
            "id" => 5402,
            "email" => "janetjordan@example.com",
            "password" => "far",
        ];
