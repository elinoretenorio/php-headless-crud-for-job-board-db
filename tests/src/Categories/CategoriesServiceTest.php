...
use JobBoard\Categories\{ CategoriesDto, CategoriesModel, ICategoriesService, CategoriesService };
...
class CategoriesServiceTest extends TestCase
{
    ...
    {
        $this->repository = $this->createMock("JobBoard\Categories\ICategoriesRepository");
        $this->input = [
            "id" => 2344,
            "name" => "matter",
