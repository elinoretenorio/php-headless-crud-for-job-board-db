...
use JobBoard\Blocks\{ BlocksDto, BlocksModel, BlocksController };
...
class BlocksControllerTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        $this->input = [
            ...
            "name" => "down",
            "url" => "ten",
            "content" => "Doctor push detail offer why skin our. Trade where add tough hair quite entire. Remain central stay maintain put score road bad.",
        ];
        $this->dto = new BlocksDto($this->input);
        $this->model = new BlocksModel($this->dto);
        $this->service = $this->createMock("JobBoard\Blocks\IBlocksService");
